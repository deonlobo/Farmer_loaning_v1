...
<html>
    ...
    <div class="center">
    	     ...
    	     <a href="diffLoanInfo.php"><h2 class="btn brand z-depth-0" style="font-size: 17px !important; margin-top:0px;">Different Poultry Loans</h2></a>
    </div>
		...
		<form class="white" action="add.php" method="POST">
			...
			<label>Bank</label>
			  <select class='btn z-depth-0 brand' name="Bank">
			    <option value="60001">Allahabad Bank</option>
			    <option value="60002">Andhra Bank</option>
			    <option value="60003">Bank Of Baroda</option>
			    <option value="60005">Bank Of  Maharashtra</option>
			    <option value="60006">Canara Bank</option>
			    <option value="60008">Corporation</option>
			    <option value="60018">Union Bank Of India</option>
			  </select>
			<label>Amount</label>
