...
<div style="text-align:center">
  ...
  <div class="blue grid-wrapper">
  	      <a href="/Farmer_loaning_v1/crop_loan/croploan.php"><div class="box zone "><img src="./img/crop.jpg"><h2>Crop Loan</h2>
                                                         <p>The loan covers the crop production expenses, post-harvest expenses, contingencies, etc.</p>
                                                         </div></a>
  	      <a href="/Farmer_loaning_v1/tractor_loan/tractorloan.php"><div class="box zone"><img src="./img/tractor.jpg">
                                           <h2>Tractor Loan</h2>
                                           <p>The Loan amount will cover the cost of tractor, accessories, implements, insurance and registration expenses.</p>
                     </div></a>
  	      <a href="/Farmer_loaning_v1/drip_loan/driploan.php"><div class="box zone"><img src="./img/drip.jpg">
                                           <h2>Drip Irrigation Loan</h2>
                                           <p>Farmers engaged in agricultural activities and own the land under cultivation are provided with loans.</p> 
                                           </div></a>
  	      <a href="/Farmer_loaning_v1/dairy_loan/dairyloan.php"><div class="box zone"><img src="./img/diary.jpg">
                                           <h2>Dairy Loan</h2>
                                           <p>The loan is provided to dairy societies for modernization and creating infrastructures .  etc.</p> 
                                           </div></a>
  	      <a href="/Farmer_loaning_v1/poultry_loan/poultryloan.php"><div class="box zone"><img src="./img/poultry.jpg">
                                           <h2>Poultry Loan</h2>
                                           <p>Loan for existing and new farmers for constructing poultry shed, feed room and other equipment’s.</p> 
                                           </div></a>
  	      <a href="/Farmer_loaning_v1/fisheries_loan/fisheriesloan.php"><div class="box zone"><img src="./img/fisheries.jpg">
  ...
  <nav class="zone blue sticky">
        <ul class=main-nav>
          ...
          <li><a href="/Farmer_loaning_v1/team1/team.html">Our Team</a></li>
