		...
		<form class="white" action="add.php" method="POST">
			...
			<label>Bank</label>
			  <select class='btn z-depth-0 brand' name="Bank">
			    <option value="20001">Allahabad Bank</option>
			    <option value="20002">Andhra Bank</option>
			    <option value="20003">Bank Of Baroda</option>
			    <option value="20005">Bank Of  Maharashtra</option>
			    <option value="20006">Canara Bank</option>
			    <option value="20008">Corporation</option>
			    <option value="20018">Union Bank Of India</option>
			  </select>
			<label>Amount</label>
