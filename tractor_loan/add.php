...
<html>
    ...
    <div class="center">
    	     ...
    	     <a href="diffLoanInfo.php"><h2 class="btn brand z-depth-0" style="font-size: 17px !important; margin-top:0px;">Different Tractor Loans</h2></a>
    </div>
		...
		<form class="white" action="add.php" method="POST">
			...
			<label>Bank</label>
			  <select class='btn z-depth-0 brand' name="Bank">
			    <option value="30001">Allahabad Bank</option>
			    <option value="30002">Andhra Bank</option>
			    <option value="30003">Bank Of Baroda</option>
			    <option value="30005">Bank Of  Maharashtra</option>
			    <option value="30006">Canara Bank</option>
			    <option value="30008">Corporation</option>
			    <option value="30018">Union Bank Of India</option>
			  </select>
			<label>Amount</label>
